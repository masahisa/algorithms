...
TEST(prim, mst_prim)
{
    ...
    std::sort(mst.begin(), mst.end(), [&](const graph_edge& lhs, const graph_edge& rhs) -> bool { return lhs.weight < rhs.weight; });
